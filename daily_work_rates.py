...
DAILY_WORK = {
    ...
    # ── 흄관/RC관 부설 (수밀밴드=고무링 접합) ──────────────────
    # 출처: 2025 건설공사 표준품셈 6-6-2 수밀밴드 접합 및 부설('23년, '25년 보완)
    # 값은 "1개 조" 하루 시공량(본). 조 편성은 condition 참조.
    # 앱의 투입조수 1 = 이 표의 1개 조(세트)에 해당한다.
    "흄관_D250":  {"daily":21, "unit":"본","crews":1,"hours":8,"condition":"수밀밴드(고무링) 접합·부설, 배관공2+보통인부1+양중장비1"},
    "흄관_D300":  {"daily":16, "unit":"본","crews":1,"hours":8,"condition":"수밀밴드(고무링) 접합·부설, 배관공2+보통인부1+양중장비1"},
    "흄관_D350":  {"daily":13, "unit":"본","crews":1,"hours":8,"condition":"수밀밴드(고무링) 접합·부설, 배관공2+보통인부1+양중장비1"},
    "흄관_D400":  {"daily":11, "unit":"본","crews":1,"hours":8,"condition":"수밀밴드(고무링) 접합·부설, 배관공2+보통인부1+양중장비1"},
    "흄관_D450":  {"daily":10, "unit":"본","crews":1,"hours":8,"condition":"수밀밴드(고무링) 접합·부설, 배관공2+보통인부1+양중장비1"},
    "흄관_D500":  {"daily":9, "unit":"본","crews":1,"hours":8,"condition":"수밀밴드(고무링) 접합·부설, 배관공2+보통인부1+양중장비1"},
    "흄관_D600":  {"daily":7, "unit":"본","crews":1,"hours":8,"condition":"수밀밴드(고무링) 접합·부설, 배관공2+보통인부1+양중장비1"},
    "흄관_D700":  {"daily":6, "unit":"본","crews":1,"hours":8,"condition":"수밀밴드(고무링) 접합·부설, 배관공2+보통인부1+양중장비1"},
    "흄관_D800":  {"daily":5, "unit":"본","crews":1,"hours":8,"condition":"수밀밴드(고무링) 접합·부설, 배관공2+보통인부1+양중장비1"},
    "흄관_D900":  {"daily":5, "unit":"본","crews":1,"hours":8,"condition":"수밀밴드(고무링) 접합·부설, 배관공3+보통인부1+양중장비1"},
    "흄관_D1000": {"daily":5, "unit":"본","crews":1,"hours":8,"condition":"수밀밴드(고무링) 접합·부설, 배관공3+보통인부1+양중장비1"},
    "흄관_D1100": {"daily":4, "unit":"본","crews":1,"hours":8,"condition":"수밀밴드(고무링) 접합·부설, 배관공3+보통인부1+양중장비1"},
    "흄관_D1200": {"daily":4, "unit":"본","crews":1,"hours":8,"condition":"수밀밴드(고무링) 접합·부설, 배관공3+보통인부1+양중장비1"},
    "흄관_D1350": {"daily":3.5, "unit":"본","crews":1,"hours":8,"condition":"수밀밴드(고무링) 접합·부설, 배관공3+보통인부1+양중장비1"},
    "흄관_D1500": {"daily":3.5, "unit":"본","crews":1,"hours":8,"condition":"수밀밴드(고무링) 접합·부설, 배관공4+보통인부1+양중장비1"},
    "흄관_D1650": {"daily":3, "unit":"본","crews":1,"hours":8,"condition":"수밀밴드(고무링) 접합·부설, 배관공4+보통인부1+양중장비1"},
    "흄관_D1800": {"daily":3, "unit":"본","crews":1,"hours":8,"condition":"수밀밴드(고무링) 접합·부설, 배관공4+보통인부1+양중장비1"},
    "흄관_D2000": {"daily":2.5, "unit":"본","crews":1,"hours":8,"condition":"수밀밴드(고무링) 접합·부설, 배관공4+보통인부1+양중장비1"},
...
WORK_KEY_MAP = [
    ...
    # 흄관/RC관 - 관경별 (큰 관경부터 매칭)
    (["흄관","RC관","원심력","철근콘크리트관"], ["D2000","2000mm","Φ2000"], "흄관_D2000"),
    (["흄관","RC관","원심력","철근콘크리트관"], ["D1800","1800mm","Φ1800"], "흄관_D1800"),
    (["흄관","RC관","원심력","철근콘크리트관"], ["D1650","1650mm","Φ1650"], "흄관_D1650"),
    (["흄관","RC관","원심력","철근콘크리트관"], ["D1500","1500mm","Φ1500"], "흄관_D1500"),
    (["흄관","RC관","원심력","철근콘크리트관"], ["D1350","1350mm","Φ1350"], "흄관_D1350"),
    (["흄관","RC관","원심력","철근콘크리트관"], ["D1200","1200mm","Φ1200"], "흄관_D1200"),
    (["흄관","RC관","원심력","철근콘크리트관"], ["D1100","1100mm","Φ1100"], "흄관_D1100"),
    (["흄관","RC관","원심력","철근콘크리트관"], ["D1000","1000mm","Φ1000"], "흄관_D1000"),
    (["흄관","RC관","원심력","철근콘크리트관"], ["D900","900mm","Φ900"], "흄관_D900"),
    (["흄관","RC관","원심력","철근콘크리트관"], ["D800","800mm","Φ800"], "흄관_D800"),
    (["흄관","RC관","원심력","철근콘크리트관"], ["D700","700mm","Φ700"], "흄관_D700"),
    (["흄관","RC관","원심력","철근콘크리트관"], ["D600","600mm","Φ600"], "흄관_D600"),
    (["흄관","RC관","원심력","철근콘크리트관"], ["D500","500mm","Φ500"], "흄관_D500"),
    (["흄관","RC관","원심력","철근콘크리트관"], ["D450","450mm","Φ450"], "흄관_D450"),
    (["흄관","RC관","원심력","철근콘크리트관"], ["D400","400mm","Φ400"], "흄관_D400"),
    (["흄관","RC관","원심력","철근콘크리트관"], ["D350","350mm","Φ350"], "흄관_D350"),
    (["흄관","RC관","원심력","철근콘크리트관"], ["D300","300mm","Φ300"], "흄관_D300"),
    (["흄관","RC관","원심력","철근콘크리트관"], ["D250","250mm","Φ250"], "흄관_D250"),
    (["흄관","RC관","원심력","철근콘크리트관"], [],                 "흄관_D300"),
